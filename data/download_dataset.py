...
from video_download import download_video_training, download_video_testing
...
def process_video():
	...
	try:
		if dl_from_training:
			download_video_training(start_idx=start_id, end_idx=end_id)
		else:
			download_video_testing(start_idx=start_id, end_idx=end_id)
