...
def download_video_training(loc='video_train',path='../audio/catalog/avspeech_train.csv',start_idx=0,end_idx=1,rm_video=False):
...
def download_video_testing(loc='video_train',path='../audio/catalog/avspeech_eval.csv',start_idx=0,end_idx=1,rm_video=False):
    # Inconsistent conditions - inclusive vs exclusive of end id
    end_idx -= 1
